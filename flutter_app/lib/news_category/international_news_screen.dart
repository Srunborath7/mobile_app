...
class InternationalNewsScreen extends StatefulWidget {
  ...
  @override
  State<InternationalNewsScreen> createState() => _InternationalNewsScreenState();
}
...
class _InternationalNewsScreenState extends State<InternationalNewsScreen> {
  ...
  Future<void> fetchTechnologyArticles() async {
    try {
      ...
      final response = await http.get(Uri.parse('$baseUrl/api/categories/article/category/4'));
